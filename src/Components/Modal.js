  ...
  return (
    <div className="modalContainer">
      ...
      <div className="body">
        ...
        <p>
          3. To restart the game the restart button can be clicked to reshuffle
          the cards.
        </p>
        <p>
          4. Incorrect guesses stay open for only a brief moment to help improve
          your recall ability over time.
        </p>
      </div>
